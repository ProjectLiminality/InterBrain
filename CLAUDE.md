...
See **[docs/known-issues.md](docs/known-issues.md)** for detailed tracking of deferred issues and technical debt.
...
- **[Technical Patterns](docs/technical-patterns.md)**: Proven algorithms, spatial layouts, and code patterns
- **[UX Specifications](docs/ux-specifications.md)**: Interaction flows, search functionality, and UX design
- **[Architecture Details](docs/architecture-details.md)**: DreamNode lifecycle, git operations, Radicle P2P model, coherence beacon system
- **[Known Issues](docs/known-issues.md)**: Deferred issues and technical debt tracking
