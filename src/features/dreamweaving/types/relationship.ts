/**
 * DreamSong Relationship Types
 *
 * Data structures for the DreamSong relationship graph extracted from canvas sequences.
 * Dreamweaving owns this data because relationships are created through the act of
 * weaving DreamTalks into DreamSongs on the canvas.
 *
 * Note: These are specifically DreamSong-derived relationships (from canvas media sequences),
 * distinct from Liminal Web relationships (social connections between Dreamers and Dreams).
 */
