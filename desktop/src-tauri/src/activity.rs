...
//! peer fetch is an HTTPS round-trip to GitHub (resolved by the
//! git-remote-interbrain helper). Future: persist scan results, schedule
//! periodic scans, push update notifications.
